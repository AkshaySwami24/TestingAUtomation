...
{
    public class COFAWorkspaceCreationPage : BasePage
    {
        public static readonly By workspaceName_Locator = By.XPath("//input[@data-placeholder='Workspace Name']");
        public static readonly By Baseobject_options_Locator = By.XPath("//span[contains(text(),'COFA')]");
        public static readonly By selectBaseobjectCTV_Locator = By.XPath("//span[@class='mat-option-text'][contains(text(),'COFA')]");
        public static readonly By SelectWorkspace_Locator = By.XPath("//td[contains(text(),'Talisma_Automation_COFA_Workspace')]");
        ...
        public COFAWorkspaceCreationPage(IWebDriver driver) : base(driver)
        {
        ...
        public void EnterWorkspaceName()
        {
            ...
            string NameWorkspace = wsheet["A11"].StringValue;
