...
{
    public class OpportunityWorkspaceCreationPage : BasePage
    {
        public static readonly By workspaceName_Locator = By.XPath("//input[@data-placeholder='Workspace Name']");
        public static readonly By Baseobject_options_Locator = By.XPath("//span[contains(text(),'Opportunity')]");    //span[@class='mat-option-text'][contains(text(),'Opportunity')]
        public static readonly By selectBaseobjectCTV_Locator = By.XPath("//span[@class='mat-option-text'][contains(text(),'Opportunity')]");
        public static readonly By SelectWorkspace_Locator = By.XPath("//td[contains(text(),' Talisma_Automation_OpportunityWorkspace')]");
        ...
        public OpportunityWorkspaceCreationPage(IWebDriver driver) : base(driver)
        {
        ...
        public void EnterWorkspaceName()
        {
            ...
            string NameWorkspace = wsheet["A5"].StringValue;
