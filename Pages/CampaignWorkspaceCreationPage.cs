...
{
    public class CampaignWorkspaceCreationPage : BasePage
    {
        public static readonly By workspaceName_Locator = By.XPath("//input[@data-placeholder='Workspace Name']");
        public static readonly By Baseobject_options_Locator = By.XPath("//span[contains(text(),'Campaign')]");
        public static readonly By selectBaseobjectCTV_Locator = By.XPath("//span[@class='mat-option-text'][contains(text(),'Campaign')]");
        public static readonly By SelectWorkspace_Locator = By.XPath("//td[contains(text(),'Talisma_Automation_CampaignWorkspace')]");
        ...
        public CampaignWorkspaceCreationPage(IWebDriver driver) : base(driver)
        {
        ...
        public void EnterWorkspaceName()
        {
            ...
            string NameWorkspace = wsheet["A10"].StringValue;
