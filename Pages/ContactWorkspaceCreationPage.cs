...
{
    public class ContactWorkspaceCreationPage : BasePage
    {
        public static readonly By workspaceName_Locator = By.XPath("//input[@data-placeholder='Workspace Name']");
        public static readonly By Baseobject_options_Locator = By.XPath("//span[@class='mat-option-text'][contains(text(),'Contact')]");
        public static readonly By selectBaseobjectCTV_Locator = By.XPath("//span[@class='mat-option-text'][contains(text(),'Contact')]");
        public static readonly By SelectWorkspace_Locator = By.XPath("//td[contains(text(),' Talisma_Automation_ContactWorkspace ')]");
        ...
        public ContactWorkspaceCreationPage(IWebDriver driver) : base(driver)
        {
        ...
        public void EnterWorkspaceName()
        {
            ...
            string NameWorkspace = wsheet["A4"].StringValue;
