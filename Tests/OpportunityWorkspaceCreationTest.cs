...
namespace Talisma_TestUI.Tests
{
   ...
   // [Parallelizable(ParallelScope.Fixtures)]
    public class OpportunityWorkspaceCreationTest : BasePageTest
    {
        private LoginPage LoginPage;
        private OpportunityWorkspaceCreationPage OpportunityWorkspaceCreationPage;
        ...
        public void SetupFixture()
        {
            ...
            OpportunityWorkspaceCreationPage = new OpportunityWorkspaceCreationPage(driver);
        ...
        [Test, Order(1)]
        public void CreateOpportunityWorkspace()
        {
            ...
            Thread.Sleep(3000);
            OpportunityWorkspaceCreationPage.EnterWorkspaceName();
            AccountWorkspaceCreationPage.selectBaseObject();
            OpportunityWorkspaceCreationPage.selectBaseObjectOption();
            ...
            OpportunityWorkspaceCreationPage.selectObjectfromOption();
            Thread.Sleep(3000);
            ...
            catch (Exception ex)
            {
                ...
                OpportunityWorkspaceCreationPage.SelectWOrkspace();
                Thread.Sleep(3000);
                GenericMethod.SaveScreenShot(driver, "CreateOpportunityWorkspace");
                Console.WriteLine(ex.Message);
            }
        }

        [Test, Order(2)]
        public void PerformViewMenuOperationsOnOpportunityWorkspace()
        {
            LoginPage.LoginToApp("a", "a");
            Thread.Sleep(2000);
            if (LoginPage.IsAlertPresent())
            ...
            GenericMethod.SaveScreenShot(driver, "PerformViewMenuOperationsOnOpportunityWorkspace");

        }

        [Test, Order(3)]
        public void PerformEditMenuOperationsOnOpportunityWorkspace()
        {
            LoginPage.LoginToApp("a", "a");
            Thread.Sleep(2000);
            if (LoginPage.IsAlertPresent())
            ...
            Thread.Sleep(4000);
            GenericMethod.SaveScreenShot(driver, "PerformEditMenuOperationsOnOpportunityWorkspace");
        }

        [Test, Order(4)]
        public void PerformRenameMenuOperationsOnOpportunityWorkspace()
        {
            LoginPage.LoginToApp("a", "a");
            Thread.Sleep(2000);
            if (LoginPage.IsAlertPresent())
        ...
        [Test, Order(5)]
        public void PerformDeleteMenuOperationsOnOpportunityWorkspace()
        {
            LoginPage.LoginToApp("a", "a");
            Thread.Sleep(2000);
            if (LoginPage.IsAlertPresent())
            ...
            Thread.Sleep(4000);
            GenericMethod.SaveScreenShot(driver, "PerformDeleteMenuOperationsOnOpportunityWorkspace");
        }
    }
}
